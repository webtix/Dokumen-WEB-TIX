...
<head>
    ...
    <title>Web-Tix Manager</title>
</head>
<body>
        <nav class="navbar navbar-expand-lg navbar-light bg-warning">
        <DIV class="container">
            <a class="navbar-brand" href="#"><h4>Web-Tix</h4></a>
			<a class="navbar-brand" href="#"><h4>Admin</h4></a>
    ...
    <div class="row">
        <div class="col mt-3">
            <div class="card-deck">
                <div class="card" >
                    <img src="assets/img/<? o['gambar'] ?>.jpg" style="margin-top:5px; height: 352px; width: 200px; align-self: center;" >
                    <div class="card-body">
                ...
                <div class="card">
                    <img src="assets/img/Contoh Poster 3.jpg" style="margin-top:5px; height: 352px; width: 200px; align-self: center;" >
                    <div class="card-body">
                ...
                <div class="card">
                    <img src="assets/img/Contoh Poster 2.jpg" style="margin-top:5px; height: 352px; width: 200px; align-self: center;" >
                    <div class="card-body">
